...
\title{Feature Extraction for Multivariate Time Series Analysis using Convolutional Neural Network}
\author{Anh-Duy Pham}
\supervisors{Dr.  Anastassia Küstenmacher \\Second Supervisor \\ Third Supervisor}
\date{November 2020}
